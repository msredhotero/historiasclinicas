...
$resGoleadores = $serviciosJugadores->traerGoleadoresPorId($id);

$resMenu = $serviciosHTML->menu($_SESSION['nombre_predio'],"Goleadores",$_SESSION['refroll_predio'],$_SESSION['torneo_predio']);
...
$lblTitulosingular	= "Goleador";
$lblTituloplural	= "Goleadores";
$lblEliminarObs		= "Si elimina el goleador se eliminara todo el contenido de este";
$accionEliminar		= "eliminarGoleadores";
    	...
    	<div class="cuerpoBox">
        	...
        	<div class="row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <div class="input-group col-md-12">
                    	<select id="refjugador" class="form-control" name="refjugador">
                    		<option value="<?php echo mysql_result($resGoleadores,0,1); ?>"><?php echo mysql_result($resGoleadores,0,2).' - '.mysql_result($resGoleadores,0,3); ?></option>
                    	</select>
                    </div>
                </div>
                ...
                <div class="form-group col-md-6">
                    ...
                    <div class="input-group col-md-12">
                    	<select id="reffixture" class="form-control" name="reffixture">
                    		<option value="<?php echo mysql_result($resGoleadores,0,'idfixture'); ?>"><?php echo mysql_result($resGoleadores,0,2).' - '.mysql_result($resGoleadores,0,'tipofecha'); ?></option>
                    	</select>
                    </div>
                </div>
                ...
                <div class="form-group col-md-6">
                    ...
                    <div class="input-group col-md-12">
                    	<input type="text" id="goles" name="goles" class="form-control" value="<?php echo mysql_result($resGoleadores,0,'goles'); ?>" required/>
                    </div>
                </div>
            ...
            <input type="hidden" id="accion" name="accion" value="modificarGoleadores" />
...
$(document).ready(function(){
	...
	function validador(){
		...
		if ($("#goles").val() == "") {
			...
			$error = "Es obligatorio el campo Goles.";
			...
			$.ajax({
				...
				success: function(data){
					...
					if (data == '') {
                                            ...
                                            $(".alert").html('<strong>Ok!</strong> Se Modifico exitosamente el <strong>Goleador</strong>. ');
