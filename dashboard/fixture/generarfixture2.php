...
<script>
 ...
 //maxDate: fecha tope D=días | M=mes | Y=año
    $( "#datepicker1" ).datepicker({ minDate: "" });
...
<h3>Fixture</h3>
    ...
    <div class="boxInfoLargo">
    	...
    	<div class="cuerpoBox">
			...
			$cad1 .= '<input type="hidden" id="cantfechas" name="cantfechas" value="'.($i + 1).'" />';
			$cad1 .= '<input type="hidden" id="total" name="total" value="'.$total.'" />';
			$cad1 .= '<input type="hidden" id="idtorneo" name="idtorneo" value="'.$_GET['idtorneo'].'" />';
			$cad1 .= '<input type="hidden" id="idzona" name="idzona" value="'.$_GET['idzona'].'" />';
	
			} else {
				$cad1 .= '<h2>Ya fue Cargado el Fixture completo para este torneo';	
			}
			?>
            <h3>Fecha 1</h3>
					  ...
					  <div>
					  	...
					  	<div>
						<select id="equipoa2" name="equipoa2" >
                                
                                <option value="1110">Zona A - Los Rebeldes</option>
                                <option value="1101">Zona A - cinco</option>
                                <option value="1102">Zona A - cuatro</option><option value="1103">Zona A - diez</option><option value="1104">Zona A - dos</option><option value="1110">Zona A - Los Rebeldes</option><option value="1105">Zona A - nueve</option><option value="1106">Zona A - ocho</option><option value="1107">Zona A - seis</option><option value="1108">Zona A - siete</option><option value="1109">Zona A - tres</option>
                         </select>
						 </div>
						 
						 <div >
						<select id="horario1" name="horario1" class="form-control">
                                
                                <option value="1">12:00:00</option><option value="2">13:30:00</option><option value="3">15:00:00</option><option value="4">16:30:00</option>    
                         </select>
						 </div>
						 
						 
						  <div >
						<select id="cancha1" name="cancha1">
                                <option value="1">Cancha 1A</option><option value="2">Cancha 2</option><option value="3">Cancha 3</option><option value="4">Cancha 4</option><option value="5">Cancha 5</option><option value="6">Cancha 6A</option><option value="7">Cancha 7</option><option value="8">Cancha 8</option><option value="9">Cancha 9</option><option value="10">Cancha 10</option><option value="11">Cancha 1B</option><option value="12">Cancha 6B</option>
                         </select>
						 </div>
						 
						 
						 <div >
						<select id="equipob1" name="equipob1">
                                <option value="1104">Zona A - dos</option>
                                <option value="1101">Zona A - cinco</option><option value="1102">Zona A - cuatro</option><option value="1103">Zona A - diez</option><option value="1104">Zona A - dos</option><option value="1110">Zona A - Los Rebeldes</option><option value="1105">Zona A - nueve</option><option value="1106">Zona A - ocho</option><option value="1107">Zona A - seis</option><option value="1108">Zona A - siete</option><option value="1109">Zona A - tres</option> 
                         </select>
						 </div>
					  	
				
				
				Fecha Juego 1 <input type="text" class="form-control" id="datepicker1" name="datepicker1" value="03/08/2015" />
				
		
					<hr><br><input type="hidden" id="cantfechas" name="cantfechas" value="2" /><input type="hidden" id="total" name="total" value="6" /><input type="hidden" id="idtorneo" name="idtorneo" value="38" /><input type="hidden" id="idzona" name="idzona" value="19" />
            <!--<textarea cols="100" rows="200">
            	<?php //echo $cad1; ?>
            </textarea>-->
