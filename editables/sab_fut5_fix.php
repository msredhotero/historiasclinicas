  ...
  <tr>
    <td><div id="TabbedPanels4" class="TabbedPanels">
      ...
      <div class="TabbedPanelsContentGroup">
        <div class="TabbedPanelsContent"><img src="../images/lineadivisoria.jpg" width="790" height="23" /></div>
        </div>
      </div>
      <p><br />
        <br />
...
<table width="790" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><div id="TabbedPanels" class="TabbedPanels">
      <ul class="TabbedPanelsTabGroup">
        <li class="TabbedPanelsTab" tabindex="0">Zona 1</li></ul>
      <div class="TabbedPanelsContentGroup">
        <div class="TabbedPanelsContent">
          <iframe src="http://www.datafutbol.net/comunidad/campeonato/tabla_fixture/667" name="Campeonato-484" width="780" height="250" scrolling="No" frameborder="0" id="Campeonato-">
            <p>Tu browser no permite mostrar estas tablas.</p>
            </iframe>
          <br />
          <img src="../images/lineadivisoria.jpg" width="790" height="23" /></div>
        </div>
      </div>
      <p><br />
        <br />
...
<table width="790" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><div id="TabbedPanels2" class="TabbedPanels">
      <ul class="TabbedPanelsTabGroup">
        <li class="TabbedPanelsTab" tabindex="0">Zona 2      </li>
      </ul>
      <div class="TabbedPanelsContentGroup">
        <div class="TabbedPanelsContent">
          <iframe src="http://www.datafutbol.net/comunidad/campeonato/tabla_fixture/668" name="Campeonato-484" width="780" height="300" scrolling="No" frameborder="0" id="Campeonato-2">
            <p>Tu browser no permite mostrar estas tablas.</p>
            </iframe>
          <br />
          <img src="../images/lineadivisoria.jpg" width="790" height="23" /></div>
...
<table width="790" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><div id="TabbedPanels3" class="TabbedPanels">
      <ul class="TabbedPanelsTabGroup">
        <li class="TabbedPanelsTab" tabindex="0">Zona 3</li>
      </ul>
      <div class="TabbedPanelsContentGroup">
        <div class="TabbedPanelsContent">
          <iframe src="http://www.datafutbol.net/comunidad/campeonato/tabla_fixture/669" name="Campeonato-484" width="780" height="300" scrolling="No" frameborder="0" id="Campeonato-3">
            <p>Tu browser no permite mostrar estas tablas.</p>
            </iframe>
          <br />
          <br />
...
<table width="790" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><div id="TabbedPanels5" class="TabbedPanels">
      <ul class="TabbedPanelsTabGroup">
        <li class="TabbedPanelsTab" tabindex="0">Zona 4</li>
      </ul>
      <div class="TabbedPanelsContentGroup">
        <div class="TabbedPanelsContent">
          <iframe src="http://www.datafutbol.net/comunidad/campeonato/tabla_fixture/670" name="Campeonato-484" width="780" height="300" scrolling="No" frameborder="0" id="Campeonato-4">
            <p>Tu browser no permite mostrar estas tablas.</p>
            </iframe>
          <br />
          </div>
