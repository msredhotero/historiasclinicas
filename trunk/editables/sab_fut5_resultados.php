...
<table width="790" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><div id="TabbedPanels2" class="TabbedPanels">
      <ul class="TabbedPanelsTabGroup">
        <li class="TabbedPanelsTab" tabindex="0">Zona 1</li>
        </ul>
      <div class="TabbedPanelsContentGroup">
        <div class="TabbedPanelsContent">
          <!-- IFRAME CON TODAS LAS TABLAS JUNTAS. -->
          <iframe src="http://www.datafutbol.net/comunidad/campeonato/tabla_ultimosresultados/667" name="Campeonato-396" width="780" height="200" scrolling="No" frameborder="0" id="Campeonato-396">
        ...
        <tr>
          <td><div id="TabbedPanels3" class="TabbedPanels">
            ...
            <div class="TabbedPanelsContentGroup">
              <div class="TabbedPanelsContent">
                <!-- IFRAME CON TODAS LAS TABLAS JUNTAS. -->
                <iframe src="http://www.datafutbol.net/comunidad/campeonato/tabla_ultimosresultados/668" name="Campeonato-396" width="780" height="200" scrolling="No" frameborder="0" id="Campeonato-">
                  <p>Tu browser no permite mostrar estas tablas.</p>
                  </iframe>
                <br />
                <br />
        ...
        <tr>
          <td><div id="TabbedPanels4" class="TabbedPanels">
            ...
            <div class="TabbedPanelsContentGroup">
              <div class="TabbedPanelsContent">
                <!-- IFRAME CON TODAS LAS TABLAS JUNTAS. -->
                <iframe src="http://www.datafutbol.net/comunidad/campeonato/tabla_ultimosresultados/669" name="Campeonato-396" width="780" height="200" scrolling="No" frameborder="0" id="Campeonato-2">
                  <p>Tu browser no permite mostrar estas tablas.</p>
                  </iframe>
                <br />
                <br />
        ...
        <tr>
          <td><div id="TabbedPanels5" class="TabbedPanels">
            ...
            <div class="TabbedPanelsContentGroup">
              <div class="TabbedPanelsContent">
                <!-- IFRAME CON TODAS LAS TABLAS JUNTAS. -->
                <iframe src="http://www.datafutbol.net/comunidad/campeonato/tabla_ultimosresultados/670" name="Campeonato-396" width="780" height="200" scrolling="No" frameborder="0" id="Campeonato-3">
                  <p>Tu browser no permite mostrar estas tablas.</p>
                  </iframe>
                <br />
                <br />
