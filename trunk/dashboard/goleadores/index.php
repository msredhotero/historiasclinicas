...
$lstCargados 	= $serviciosFunciones->camposTablaView($cabeceras,$serviciosJugadores->traerGoleadores(),5);
...
<h3><?php echo $lblTituloplural; ?></h3>
    ...
    <div class="boxInfoLargo">
    	...
    	<div class="cuerpoBox">
            ...
            <input type="hidden" id="accion" name="accion" value="insertarGoleadores" />
            </form>
    	</div>
    </div>
